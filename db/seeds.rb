...
c_uk      = Country.create(name: 'uk', image:'http://cdn.londonandpartners.com/visit/london-organisations/houses-of-parliament/63950-640x360-london-icons2-640.jpg')
...
c_finland = Country.create(name: 'finland', image:'http://nordictravel.com.au/image/type/galleryFullImage/id/4643/filename/c.+Jiang+Ping+Visit+Finland+72464_000_04.jpg')
...
c_germ    = Country.create(name: 'germany', image:'http://students.marshall.usc.edu/undergrad/files/2014/09/berlin.jpg')
c_hung    = Country.create(name: 'hungary', image:'http://www.salusexpress.hr/modules/destination/galleries/budimpesta/IMG_006733-F3A0C0-77467A-166352-648576-A60F28.jpg')
c_austria = Country.create(name: 'austria', image:'http://tourop.travelberry.net/data/country_images/214_27082015_103608_AUSTRIASMALL.jpg')
c_russia  = Country.create(name: 'russia', image:'http://www.sigmalive.com/en/uploads/images/news/russia-investing_in_cyprus.jpg')
c_poland  = Country.create(name: 'poland', image:'http://www3.hilton.com/resources/media/hi/WAWHIHI/en_US/img/shared/full_page_image_gallery/main/HL_warsawoldtown3_31_675x359_FitToBoxSmallDimension_Center.jpg')
...
# CITIES
  ...
  city_seattle  = City.create(name:'seattle', country_id: c_usa.id, image:'http://media-cdn.tripadvisor.com/media/photo-o/03/9b/30/26/seattle.jpg')
  city_philly   = City.create(name:'philadelphia', country_id: c_usa.id, image:'http://www.towerstream.com/wp-content/uploads/2014/03/Philadelphia.jpg')
  city_sandiego = City.create(name:'san diego', country_id: c_usa.id, image:'http://media-cdn.tripadvisor.com/media/photo-s/05/a4/ee/8f/san-diego.jpg')
  city_miami    = City.create(name:'miami', country_id: c_usa.id, image:'http://www.miamiandbeaches.com/~/media/images/gmcvb/miamiandbeaches/travel%20guides/itineraries/large%20images%20452x406/itineraries-miami-for-first-timers-452x406.ashx')
  city_wash     = City.create(name:'washington', country_id: c_usa.id, image:'http://foxtravelandtours.com/old-ref/New%20Folder/assets/washington%207.jpg')
  city_fortlaud = City.create(name:'fort lauderdale', country_id: c_usa.id, image:'http://media-cdn.tripadvisor.com/media/photo-s/03/9b/2f/7e/fort-lauderdale.jpg')
  ...
  city_london   = City.create(name:'london', country_id: c_uk.id, image:'http://cdn.londonandpartners.com/visit/london-organisations/houses-of-parliament/63950-640x360-london-icons2-640.jpg')
  ...
  city_berlin   = City.create(name:'berlin', country_id: c_germ.id, image: 'http://students.marshall.usc.edu/undergrad/files/2014/09/berlin.jpg')
  city_prague   = City.create(name:'prague', country_id: c_czech.id, image: 'http://finedininglovers.cdn.crosscast-system.com/BlogPost/xl_6468_TP-prague-finedininglovers.jpg')
  city_budapest = City.create(name:'hungary', country_id: c_hung.id, image:'http://www.salusexpress.hr/modules/destination/galleries/budimpesta/IMG_006733-F3A0C0-77467A-166352-648576-A60F28.jpg')
  city_rome     = City.create(name:'rome', country_id: c_italy.id, image: 'http://myonlinedestinations.com/wp-content/uploads/2015/04/coliseum-hdr-1600x939-wallpaper-1683138.jpg')

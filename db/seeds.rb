...
c_uk      = Country.create(name: 'uk', image:'https://cdn.londonandpartners.com/visit/london-organisations/houses-of-parliament/63950-640x360-london-icons2-640.jpg')
c_spain   = Country.create(name: 'spain', image:'https://www.askaboutsports.com/images/bull-fighting/bullfight-bsp-23708306-500x390.jpg')
c_czech   = Country.create(name: 'czech republic', image:'https://finedininglovers.cdn.crosscast-system.com/BlogPost/xl_6468_TP-prague-finedininglovers.jpg')
c_italy   = Country.create(name: 'italy', image:'https://myonlinedestinations.com/wp-content/uploads/2015/04/coliseum-hdr-1600x939-wallpaper-1683138.jpg')
c_france  = Country.create(name: 'france', image:'https://dreamatico.com/data_images/paris/paris-8.jpg')
...
c_norway  = Country.create(name: 'norway', image:'https://d33gqm9lw3yglq.cloudfront.net/ImageVaultFiles/id_545/cf_878/alesund_w_740x334.JPG')
c_finland = Country.create(name: 'finland', image:'https://nordictravel.com.au/image/type/galleryFullImage/id/4643/filename/c.+Jiang+Ping+Visit+Finland+72464_000_04.jpg')
...
c_germ    = Country.create(name: 'germany', image:'https://students.marshall.usc.edu/undergrad/files/2014/09/berlin.jpg')
c_hung    = Country.create(name: 'hungary', image:'https://www.salusexpress.hr/modules/destination/galleries/budimpesta/IMG_006733-F3A0C0-77467A-166352-648576-A60F28.jpg')
c_austria = Country.create(name: 'austria', image:'https://tourop.travelberry.net/data/country_images/214_27082015_103608_AUSTRIASMALL.jpg')
c_russia  = Country.create(name: 'russia', image:'https://www.sigmalive.com/en/uploads/images/news/russia-investing_in_cyprus.jpg')
c_poland  = Country.create(name: 'poland', image:'https://www3.hilton.com/resources/media/hi/WAWHIHI/en_US/img/shared/full_page_image_gallery/main/HL_warsawoldtown3_31_675x359_FitToBoxSmallDimension_Center.jpg')

# CITIES
  ## USA
  city_la       = City.create(name:'los angeles', country_id: c_usa.id, image:'https://students.marshall.usc.edu/undergrad/files/2012/04/Selling-Your-Los-Angeles-Home1.jpeg')
  ...
  city_philly   = City.create(name:'philadelphia', country_id: c_usa.id, image:'https://www.towerstream.com/wp-content/uploads/2014/03/Philadelphia.jpg')
  ...
  city_miami    = City.create(name:'miami', country_id: c_usa.id, image:'https://www.miamiandbeaches.com/~/media/images/gmcvb/miamiandbeaches/travel%20guides/itineraries/large%20images%20452x406/itineraries-miami-for-first-timers-452x406.ashx')
  city_wash     = City.create(name:'washington', country_id: c_usa.id, image:'https://foxtravelandtours.com/old-ref/New%20Folder/assets/washington%207.jpg')
  ...
  city_london   = City.create(name:'london', country_id: c_uk.id, image:'https://cdn.londonandpartners.com/visit/london-organisations/houses-of-parliament/63950-640x360-london-icons2-640.jpg')
  ...
  city_prague   = City.create(name:'prague', country_id: c_czech.id, image: 'https://finedininglovers.cdn.crosscast-system.com/BlogPost/xl_6468_TP-prague-finedininglovers.jpg')
